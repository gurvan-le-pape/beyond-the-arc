// src/frontend/shared/components/charts/overlays/hotspots/ApexStripeZones.tsx
...
const ApexStripeZones: React.FC<ApexStripeZonesProps> = ({
  shots,
  xScale,
  yScale,
  colorScale,
  ...
  // Retrieve apex stripe zone geometry
  const zones = React.useMemo(() => getApexStripeZone(), []);
...
export default ApexStripeZones;
